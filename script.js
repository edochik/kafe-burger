...
// function getPartialData2(items, key, ...rest) {
// 	const objectKeys = Object.fromEntries(items.map(item => [item[key], item]))

// 	const result = Object.values(objectKeys).map(item => getPartial(item, [key, ...rest]))
// 	return result
// }

// function getPartial(item, criteries) {
// 	const result = {}
// 	for (const criteria of criteries) {
// 		result[criteria] = item[criteria]
// 	}
// 	return result
// }

// console.log(getPartialData2(products, 'weight', 'nameRu'));
